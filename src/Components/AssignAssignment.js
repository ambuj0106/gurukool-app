                  ...
                  <div className="col-lg-6">
                    <div className="card-body p-md-5 mx-md-4">
                      <div className="text-center heading">
                        <h4 onClick={toHome} className="mt-1 mb-5 pb-1">
                          Gurukool
                        </h4>
                      </div>
                  ...
                  <div className="col-lg-6 d-flex align-items-center gradient-custom-2">
                    <div className="text-white px-3 py-4 p-md-5 mx-md-4">
                      ...
                      <p className="small mb-0">
                        {" "}
                        Assignments create teaching and learning opportunities
                        to think and learn about ideas, topics, events, and
                        questions—about specific content in the curriculum. This
                        is why a quality assignment is the hallmark of effective
                        instruction.
                      </p>
                    </div>
                  </div>
